...
Example:
    python hourly_frequencies.py ../write-data-in-csv/csv-files/CommitPercentagesPerHour.csv 2004 2023
"""
import csv
import numpy as np
...
def hourly_frequencies(hours, period_hours1, period_hours2, period_name1, period_name2):
    ...
    plt.savefig(f'percentages_per_hour_{period_name1}vs{period_name2}.pdf', format='pdf', bbox_inches='tight', pad_inches=0)
